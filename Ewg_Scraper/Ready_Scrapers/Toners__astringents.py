...
CATEGORY_NAME = "Toners__astringents"
START_PAGE = 1
END_PAGE = 108
OUTPUT_FILE = Path(__file__).with_name("Toners__astringents.csv")
...
def _configure() -> dict:
    ...
    cfg["PAGE_BATCH_SIZE"] = min(max(10, cfg.get("PAGE_BATCH_SIZE", 500)), END_PAGE - START_PAGE + 1)
    return cfg
